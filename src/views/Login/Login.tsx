...
const Login = () => {
  ...
  return (
    ...
    >
      <div
        className="bg-primary-600 w-[318px] h-full"
      >
        <Image
          src={logo}
          alt="Brand Logo"
      ...
      <div className="flex justify-center items-center grow h-full">
        <div className="w-[400px]">
          ...
          <form className="w-full flex flex-col gap-8 my-8" onSubmit={isSubmitting ? noop : handleSubmit(onSubmit)}>
            <Controller
              control={control}
              name="username"
              defaultValue=""
            ...
            <Controller
              ...
              render={({ field: { onChange, value, ref } }) => (
                <TextField
                  ...
                  appendObject={(
                    <Button variant="text" className="p-0 [&>*]:fill-n-7" onClick={toggleShowPassword}>
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password">
                <Button variant="text" className="p-0 text-n-8">Forgot Password?</Button>
              </Link>
            </div>
